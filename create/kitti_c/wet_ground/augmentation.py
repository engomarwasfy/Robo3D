...
def ground_water_augmentation(pointcloud, water_height=0.0012, pavement_depth=0.0012, noise_floor=0.7, power_factor=15,
                              estimation_method='linear', flat_earth=False, debug=False,
    ...
    return augmented_pointcloud, sum(zero_points) / len(pointcloud)
...
if __name__ == '__main__':
    ...
    def _map(i: int) -> None:
        ...
        augmented_pointcloud, drop_ratio = ground_water_augmentation(points, water_height=args.water_height, noise_floor=args.noise_floor)
        # light: water_height=0.2mm, noise_floor=0.2; moderate: water_height=1.0mm, noise_floor=0.2; heavy: water_height=1.2mm, noise_floor=0.2;
